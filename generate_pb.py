...
def cnn_model_fn(features):
    ...
    conv1 = tf.layers.conv2d(inputs=input_layer, filters=64, kernel_size=[3, 3],
                             ...
                             bias_initializer=batch_init, padding="same", activation=tf.nn.relu)
...
# Save CNN Model in Pb format
frozen_graph = freeze_session(K.get_session(), output_names=None)
tf.train.write_graph(frozen_graph, "../model/", "my_model1.pb", as_text=False)
